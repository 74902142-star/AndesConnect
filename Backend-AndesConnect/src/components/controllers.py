...
async def descargar_certificado(
    ...
    nombre_estudiante = perfil.nombre if perfil else "Estudiante AndesConnect"
    ...
    instructor_curso = curso.instructor if curso else "Instructor AndesConnect"
...
<head>
  <meta charset="UTF-8">
  <title>Certificado de Aprobación - AndesConnect</title>
  <style>
    body {{
...
<body>
  <div class="certificate-container">
    <div class="inner-border">
      ...
      <div class="header">AndesConnect Educa</div>
      ...
      <div class="footer-section">
        <div class="meta-box">
          ...
          <strong>Verificación:</strong> andesconnect.org/certs/{cert.codigo_certificado}
        </div>
    ...
    <div class="badge-seal">Oficial<br>AndesConnect</div>
  </div>
</body>
</html>
"""
